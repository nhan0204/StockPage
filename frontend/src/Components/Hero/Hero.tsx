...
const Hero: React.FC<HeroProps> = () => {
    return (
        <section id="hero">
            <div className='container flex flex-col-reverse items-center justify-center xl:justify-evenly mx-auto px-8 lg:flex-row xl my-0 mt-12'>
                ...
                {/* Image */}
                <div className='xl:mt-20 w-10/12 lg:w-1/2 xl:scale-110'>
