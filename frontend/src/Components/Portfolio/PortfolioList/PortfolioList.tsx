            ...
            <div className='container max-w-sm md:max-w-xl lg:max-w-3xl xl:max-w-6xl'>
                ...
                <div className='bg-dark rounded-2xl py-4 px-6 mt-4 '>
                    {portfolioValues.length > 0 ? (
                        <div className='container max-w-sm mx-auto p-0 gap-3 grid grid-cols-1 md:max-w-xl md:grid-cols-3 lg:max-w-3xl lg:grid-cols-4 xl:grid-cols-6 xl:max-w-6xl xl:mt-6 xl:gap-4'>
